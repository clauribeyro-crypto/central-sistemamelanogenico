...
urlpatterns = [
    ...
    path("acompanhamentos/<int:pk>/excluir/", views.acompanhamento_excluir, name="acompanhamento_excluir"),
    path("acompanhamentos/<int:pk>/reabrir/", views.reabrir_acompanhamento, name="reabrir_acompanhamento"),
