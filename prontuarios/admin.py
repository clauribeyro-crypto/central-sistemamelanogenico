...
from .models import Anamnese, Atendimento, Documento, LinkAnamnese
...
class AnamneseAdmin(OrganizacaoAdminMixin, admin.ModelAdmin):
    list_display = ("paciente", "atualizado_em")
    search_fields = ("paciente__nome",)
    autocomplete_fields = ("paciente",)


@admin.register(LinkAnamnese)
class LinkAnamneseAdmin(admin.ModelAdmin):
    list_display = ("paciente", "token", "ativo", "criado_em", "preenchido_em")
    list_filter = ("ativo",)
    search_fields = ("paciente__nome",)
    autocomplete_fields = ("paciente",)
